...
from websocket_app.consumers import MySyncConsumer, MyAsyncConsumer, MyWebsocketConsumer, TicketConsumer
...
websocket_urlpatterns = [
    ...
    re_path(r"ws/TicketConsumer/$", TicketConsumer.as_asgi()),
