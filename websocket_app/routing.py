...
from websocket_app.consumers import MySyncConsumer, MyAsyncConsumer, MyWebsocketConsumer, MyJsonWebsocketConsumer
...
websocket_urlpatterns = [
    ...
    re_path(r"ws/MyJsonWebsocketConsumer/(?P<room_name>\w+)/$", MyJsonWebsocketConsumer.as_asgi()),
]