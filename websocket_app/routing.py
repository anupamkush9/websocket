...
from websocket_app.consumers import MySyncConsumer, MyAsyncConsumer, MyWebsocketConsumer, MyAsyncWebsocketConsumer, MyAsyncJsonWebsocketConsumer
...
websocket_urlpatterns = [
    ...
    re_path(r"ws/MyAsyncJsonWebsocketConsumer/(?P<room_name>\w+)/$", MyAsyncJsonWebsocketConsumer.as_asgi()),
]